...
contract TokenGeyser is IStaking, Ownable {
    ...
    constructor(
        ...
        require(
            ...
            "TokenGeyser: cannot set 0 address"
        );
        require(
            address(distributionToken) != address(0),
            "TokenGeyser: cannot set 0 address"
        );
        ...
        )
    {
        ...
        // Global accounting
        uint256 newStakingShareSeconds = block.timestamp.sub(_lastAccountingTimestampSec).mul(
                totalStakingShares
            );
        ...
        // User Accounting
        UserTotals storage totals = _userTotals[msg.sender];
        uint256 newUserStakingShareSeconds = block.timestamp.sub(totals.lastAccountingTimestampSec).mul(
        ...
        onlyOwner
    {
        ...
        console.log("[sc] blockTimestamp:", block.timestamp);
        ...
        uint256 lpb1 = _lockedPool.balance();
        console.log("[sc] lockedPool bce:", lpb1, ", amount:", amount);
        require(
        ...
        uint256 lpb2 = _lockedPool.balance();
        console.log("[sc] lockedPool bce:", lpb2);
